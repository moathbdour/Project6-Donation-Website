<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrgReqDetails.aspx.cs" Inherits="MyAdminDashBoardProject6.AdminDash.OrgReqDetails" %>
...
<%--                </div>--%>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Project6ConnectionString %>"
        SelectCommand="SELECT * FROM Orders INNER JOIN AspNetUsers ON CustomerID= AspNetUsers.Id And OrderID=@OrderID" 
        ...
        <UpdateParameters>
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="OrderID,Id" DataSourceID="SqlDataSource1"  CssClass="table table-striped donmar" HeaderText="Details">
                <Fields>
                    <asp:BoundField DataField="UserName" HeaderText="Beneficery" SortExpression="UserName" />
