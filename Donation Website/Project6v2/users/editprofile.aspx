...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr class="mt-0 mb-4">
        ...
        <asp:GridView Width="100%"  BorderWidth="0px" BorderColor="White" ID="GridView1" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" DataKeyNames="Id" AutoGenerateEditButton="True" OnRowUpdating="GridView1_RowUpdating" OnRowEditing="GridView1_RowEditing" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"  >
            <Columns>
                ...
                <asp:TemplateField HeaderText="userimages" SortExpression="userimages" Visible="False">
                    <EditItemTemplate>
                           <asp:FileUpload ID="FileUpload2" runat="server" Enabled='<%# Bind("userimages") %>' />
                    </EditItemTemplate>
                    <ItemTemplate>
