<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Project6v2.Account.Register" %>
...
<section class="text-center text-lg-start">
  ...
  <div class="container py-4">
    <div class="row g-0 align-items-center">
          ...
          <div class="card-body p-5 shadow-5 text-center">
            <h2 class="fw-bold mb-5">Sign up now</h2>
              ...
              <div class="form-outline mb-4 align-items-center">
                 <label class="form-label" for="Phone">you are</label>
                <asp:RadioButtonList CssClass="table" ID="RadioButtonList1" runat="server" RepeatDirection="Horizontal" CellSpacing="200">
      ...
      <div class="col-lg-6 mb-5 mb-lg-0">
        <img src="images/65.jpg" class="w-75 rounded-4 shadow-4"
          alt="" />
      </div>
    </div>
  </div>
